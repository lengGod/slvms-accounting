    ...
    <div class="container-fluid p-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('debtors.create')); ?>" class="btn btn-primary">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="<?php echo e(route('debtors.index')); ?>" method="GET" class="row g-3 mb-4">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                        <a href="<?php echo e(route('debtors.index')); ?>" class="btn btn-outline-secondary w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $debtors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $debtor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($debtor->hasTitipan()): ?>
                                            <span class="text-info fw-medium">
                                                <?php echo e($debtor->formatted_total_titipan); ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="<?php echo e(route('debtors.show', $debtor->id)); ?>"
                                                class="btn btn-sm btn-outline-primary" title="Detail">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('debtors.edit', $debtor->id)); ?>"
                                                class="btn btn-sm btn-outline-secondary" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="<?php echo e(route('debtors.destroy', $debtor->id)); ?>" method="POST"
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="text-muted">
                        Menampilkan <?php echo e($debtors->firstItem()); ?> - <?php echo e($debtors->lastItem()); ?> dari <?php echo e($debtors->total()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\slv-acounting\resources\views/debtors/index.blade.php ENDPATH**/ ?>