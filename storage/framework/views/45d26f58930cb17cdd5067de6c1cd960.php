                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount"
                                    value="<?php echo e(round($transaction->amount)); ?>" min="0"
                                    step="1">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="bagi_hasil" name="bagi_hasil"
                                    value="<?php echo e(round($transaction->bagi_hasil ?? 0)); ?>" min="0"
                                    step="1">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="bagi_pokok" name="bagi_pokok"
                                    value="<?php echo e(round($transaction->bagi_pokok ?? 0)); ?>" min="0"
                                    step="1">
                            </div>
