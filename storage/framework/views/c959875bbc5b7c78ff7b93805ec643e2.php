                        ...
                        <div class="col-md-6" id="pokokInputContainer" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="pokok_balance" name="pokok_balance"
                                    value="<?php echo e(old('pokok_balance', $debtor->initial_pokok_balance ?? 0)); ?>" step="any">
                            </div>
                            <div class="form-text">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            (function() {
                ...
                document.addEventListener('DOMContentLoaded', initEditDebtorForm);
                document.addEventListener('turbo:load', initEditDebtorForm);
