<?php if(!empty($pageTitle)): ?>
    <header>
        <div class="d-flex align-items-center">
            ...
            <h2 class="h5 fw-bold mb-0 text-dark d-none d-sm-block"><?php echo e($pageTitle); ?></h2>
            <h2 class="h6 fw-bold mb-0 text-dark d-sm-none"><?php echo e($pageTitle); ?></h2>
        </div>
            ...
            <div class="position-relative">
                <button id="profileDropdown" class="btn d-flex align-items-center gap-2" type="button">
                    ...
                    <div class="text-start d-none d-md-block">
                        ...
                        <div class="text-muted small"><?php echo e(ucfirst(auth()->user()->role)); ?></div>
                    </div>
                    <i class="bi bi-chevron-down text-muted dropdown-icon"></i>
                </button>
                <div id="profileMenu" class="profile-dropdown-menu">
                    <a href="<?php echo e(route('settings.profile')); ?>" class="profile-dropdown-item">
                        <i class="bi bi-person me-2"></i> Profil Saya
                    </a>
                    <a href="<?php echo e(route('settings.password')); ?>" class="profile-dropdown-item">
...
<?php /**PATH C:\laragon\www\slv-acounting\resources\views/partials/header.blade.php ENDPATH**/ ?>