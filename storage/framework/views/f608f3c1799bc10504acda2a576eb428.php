        ...
        <div class="container-fluid p-4">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    ...
                    <a href="<?php echo e(route('reports.export-debit-piutang', ['month' => request('month', \Carbon\Carbon::now()->format('Y-m'))])); ?>"
                        ...
                        <table class="table table-hover align-middle">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $debtors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $debtor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-end">Rp
                                            <?php echo e(number_format(abs($debtor->total_piutang), 0, ',', '.')); ?>

                                        </td>
                                        <td class="text-end">Rp
                                            <?php echo e(number_format(abs($debtor->total_pembayaran), 0, ',', '.')); ?>

                                        </td>
                                        <td class="text-end <?php echo e($debtor->current_balance < 0 ? 'text-danger' : ''); ?>">
                                            Rp <?php echo e(number_format(abs($debtor->current_balance), 0, ',', '.')); ?>
                            ...
                            <tfoot>
                                <tr class="table-primary fw-bold">
                                    <td>Total</td>
                                    <td class="text-end">Rp <?php echo e(number_format(abs($totalPiutang), 0, ',', '.')); ?></td>
                                    <td class="text-end">Rp <?php echo e(number_format(abs($totalPembayaran), 0, ',', '.')); ?></td>
                                    <td colspan="2"></td>
                                </tr>
                            </tfoot>
                        </table>
