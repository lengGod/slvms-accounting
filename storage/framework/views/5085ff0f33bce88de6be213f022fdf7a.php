                    ...
                    <div class="card-body d-flex flex-column justify-content-start align-items-start text-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="card-text fs-5 fw-bold mb-0">Rp <?php echo e(number_format($totalPiutang, 0, ',', '.')); ?>
                    ...
                    <div class="card-body d-flex flex-column justify-content-start align-items-start text-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="card-text fs-5 fw-bold mb-0">Rp <?php echo e(number_format($totalPembayaran, 0, ',', '.')); ?>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="card-text fs-5 fw-bold mb-0">Rp
                                    <?php echo e(number_format($totalSaldoTitipan, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
