...
<?php $__env->startSection('content'); ?>
    <div id="print-content">
        <div class="container-fluid p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold">Laporan Pembayaran Per Bulan</h1>
                    <p class="text-muted">Laporan pembayaran per bulan untuk tahun <?php echo e($year); ?>.</p>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <button class="btn btn-outline-secondary me-2 no-print" onclick="printContent()">
                        <i class="bi bi-printer me-1"></i> Cetak
                    </button>
                    <a href="<?php echo e(route('reports.export-pembayaran-perbulan', ['year' => $year])); ?>"
            ...
            <div class="card shadow-sm mb-4 no-print">
                <div class="card-body">
                    <form action="<?php echo e(route('reports.pembayaran-perbulan')); ?>" method="GET" class="row g-3">
                        <div class="col-md-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\slv-acounting\resources\views/reports/pembayaran_perbulan.blade.php ENDPATH**/ ?>