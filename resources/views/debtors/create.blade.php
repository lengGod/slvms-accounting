                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="category" name="category" required>
                                ...
                                <option value="internal" {{ old('category') == 'internal' ? 'selected' : '' }}>Internal
                                </option>
                                <option value="eksternal" {{ old('category') == 'eksternal' ? 'selected' : '' }}>Eksternal
                                </option>
                            </select>
                            @error('category')
                                <div class="text-danger small">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="pokok_balance" name="pokok_balance"
                                            value="{{ old('pokok_balance') }}" step="100">
                                    </div>
                                    <div class="form-text">
