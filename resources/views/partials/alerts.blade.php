@if (session('success') || session('error'))
    ...
    <div id="flashNotification" class="position-fixed top-0 end-0 p-3" style="z-index: 1080; width: 350px;">
        <div class="card shadow-lg border-0 overflow-hidden notification-card {{ session('success') ? 'success' : 'danger' }}" 
            ...
            <div class="position-absolute top-0 start-0 w-100" style="height: 3px; background: rgba(0,0,0,0.05);">
                <div id="notificationProgress" class="h-100 {{ session('success') ? 'bg-success' : 'bg-danger' }}" 
            ...
            <div class="card-body py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0 fw-bold {{ session('success') ? 'text-success' : 'text-danger' }}">
